"""Build the 26 survey pages (13 prompts x base/Gemma4 condition) for the flux1 model.
...
Images: survey_images/flux1_base/<id>.png and survey_images/flux1_gemma/<id>.png.
